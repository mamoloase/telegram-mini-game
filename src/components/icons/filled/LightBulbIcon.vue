<template>
    ...
    <svg :width="props.width" :height="props.height" viewBox="0 0 64 64" enable-background="new 0 0 64 64"
        ...
        <g id="SVGRepo_iconCarrier">
            <g>
                ...
                <g>
                    <path fill="#B4CCB9" d="M24,60c0,1.105,0.896,2,2,2h12c1.104,0,2-0.895,2-2v-2H24V60z"></path>
                    <rect x="24" y="52" fill="#B4CCB9" width="16" height="4"></rect>
                    <rect x="24" y="46" fill="#B4CCB9" width="16" height="4"></rect>
                </g>
                <path fill="#F9EBB2" d="M34,44h-4V25c0-1.104,0.896-2,2-2s2,0.896,2,2V44z"></path>
            </g>
        </g>
    </svg>
</template>
