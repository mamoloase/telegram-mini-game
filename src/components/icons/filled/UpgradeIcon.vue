    ...
    <svg viewBox="0 0 64 64" :width="props.width" :height="props.height" fill="#000000">
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path
                ...
                fill="#1f4863"></path>
            <path d="m27.38 16.43c-.06-.31.38-10.5 5.5-10.63s5.25 11.38 4.75 11.56-2-.93-5.62-.62-4.44.69-4.63-.31z"
                fill="#1d1d1b"></path>
            <path d="m28.69 15.49c-.32-.19.63-8.75 4.38-8.38s3.75 8.25 3.19 8.38-2.07-.44-3.94-.38-3.19.63-3.63.38z"
                fill="#1f4863"></path>
            <g fill="#1d1d1b">
                <path
