<template>
    <svg viewBox="0 0 128 128" :width="props.width" :height="props.height" preserveAspectRatio="xMidYMid meet"
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path d="M29.89 34.82c-5.97 5.42-8.58 11.02-8.58 11.02s22.26.46 22.32.12c.07-.43-13.74-11.14-13.74-11.14z"
                fill="#ffd61c"> </path>
            <path
            ...
            <g fill="#ffd61c">
                ...
                <path
                    d="M78.96 31.72c-3.26-2.28-7.13-4.32-11.67-5.64c-1.27 4.8-4.05 16.43-4.33 17.9c-.11.55-.5 1.72-.23 1.94c.28.23 1.29-.42 2.16-1.26c.99-.96 14.07-12.94 14.07-12.94z">
                </path>
            </g>
            <path
            ...
            <g fill="#ffffff">
                <path
                    d="M70.17 74.52c.3-8.71-1.83-14.6-2.95-17.06l-19.89.03c-1.22 2.91-3.4 9.21-3.22 16.87c.19 8.35 2.38 14.95 3.29 17.36l20.51-.08c.69-2.68 1.96-8.65 2.26-17.12z">
                </path>
                <path
                    d="M91.71 57.43l-21.75.03c1.29 3.21 3.4 9.78 3 17.64c-.41 7.91-1.83 14.01-2.51 16.52l20.61-.09s5.25-6.37 5.72-16.3c.46-9.93-5.07-17.8-5.07-17.8z">
                </path>
            </g>
            <path d="M27.65 91.81l9.89-.05s-.76-2.78-4.52-2.68c-3.84.12-5.37 2.73-5.37 2.73z" fill="#fab037"> </path>
            <path d="M54.08 91.7l7.58-.04s-.07-2.29-3.78-2.24c-3.2.04-3.67 2.02-3.8 2.28z" fill="#ffd429"> </path>
            <path
                d="M78.53 91.6l8.77-.05s.45-2.5-1.81-2.7c-1.92-.17-2.39 1.62-2.39 1.62s-.42-1.29-2.09-1.32c-2.01-.04-2.57 2.15-2.48 2.45z"
                fill="#a75fb7"> </path>
            <path d="M76.73 57.45l11.51-.02s.07 3.58-4.42 3.67c-6.4.13-7.09-3.65-7.09-3.65z" fill="#febf21"> </path>
            <path d="M53.31 57.47s-.73 2.47-.22 2.95c.6.55 8.66.66 9.22-.02c.56-.69-.14-2.94-.14-2.94l-8.86.01z"
                fill="#5b6467"> </path>
            <path d="M27.29 57.5l11.5-.02s.11 2.93-5.06 2.99c-5.86.08-6.44-2.97-6.44-2.97z" fill="#4e9226"> </path>
            <path
                d="M51.64 66.61c-.43.03-1.07-1.79-1.84-1.62c-.77.17-1.84.38-1.62 5.34s.6 5.38 1.58 5.34c.98-.04 2.48-2.9 2.48-2.9s1.05-.45 1.78-.5c.73-.04 1.25.62 2.15.92c.9.3 2.18.34 2.18.34s-3.03 2.56-4.06 5.85s-1.07 6.53-.81 6.74c.26.21 8.07.3 8.37.09c.3-.21-.13-9.05 1.45-11.82c1.58-2.77 3.71-6.1 3.71-6.1s-.81-2.18-1.49-2.43c-.68-.26-2.13.81-3.93.73c-1.79-.09-3.89-1.87-4.95-2.18c-1.8-.53-3.72 2.11-5 2.2z"
                fill="#ff2b26"> </path>
            <path
                d="M24.66 66.4c-.43.03-1.03-1.42-1.82-1.47c-.91-.06-1.58.08-1.64 5.03c-.05 4.86.62 5.86 1.6 5.82s2.47-3.08 2.47-3.08s.8-.5 1.55-.25c.69.23 1.23.68 2.28.83c.94.13 2 .29 2 .29s-2.75 2.47-3.78 5.75c-1.02 3.29-1.07 6.53-.81 6.74c.26.21 8.07.3 8.37.09c.3-.21.06-8.75 1.64-11.53s3.53-6.4 3.53-6.4s-.81-2.18-1.49-2.43c-.68-.26-2.46.59-4.25.5c-1.79-.09-3.74-1.73-4.84-1.89c-2.04-.3-3.53 1.92-4.81 2z"
                fill="#ff2b26"> </path>
            <path
